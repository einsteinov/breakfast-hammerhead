...
static const struct snd_kcontrol_new taiko_snd_controls[] = {
	...
	SOC_SINGLE_S8_TLV_RO("RX1 Digital Volume",
		TAIKO_A_CDC_RX1_VOL_CTL_B2_CTL, -84, 40, digital_gain),
	SOC_SINGLE_S8_TLV_RO("RX2 Digital Volume",
		TAIKO_A_CDC_RX2_VOL_CTL_B2_CTL, -84, 40, digital_gain),
	...
	SOC_SINGLE_S8_TLV("RX6 Digital Volume", TAIKO_A_CDC_RX6_VOL_CTL_B2_CTL,
		-84, 40, digital_gain),
	SOC_SINGLE_S8_TLV_RO("RX7 Digital Volume",
		TAIKO_A_CDC_RX7_VOL_CTL_B2_CTL, -84, 40, digital_gain),
	...
	SOC_SINGLE_S8_TLV("DEC5 Volume", TAIKO_A_CDC_TX5_VOL_CTL_GAIN, -84, 40,
		digital_gain),
	SOC_SINGLE_S8_TLV_RO("DEC6 Volume", TAIKO_A_CDC_TX6_VOL_CTL_GAIN, -84,
		40, digital_gain),
	SOC_SINGLE_S8_TLV_RO("DEC7 Volume", TAIKO_A_CDC_TX7_VOL_CTL_GAIN, -84,
		40, digital_gain),
